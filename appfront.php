      ...
      <!--====================================CAROUSEL================================================-->
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active" id="item"  style="height:80%;">
              <img src="pics/fr.jpg"  alt="..." >
              <div class="carousel-caption">
                <!--to write on image-->
              </div>
            </div>
            <div class="item" id="item"  style="height:80%;">
              <img src="pics/icecr2.jpg" alt="...">
              <div class="carousel-caption">
            ...
            <div class="item" id="item"  style="height:80%;">
              <img src="pics/icecr3.jpg" alt="...">
              <div class="carousel-caption">
                
              </div>
            </div>
            <div class="item" id="item"  style="height:80%;">
              <img src="pics/pizza4.jpg" alt="...">
              <div class="carousel-caption">
                
              </div>
            </div>
          </div>
        <!-- width="100%" height="344.56px"-->
          <!-- Controls -->
